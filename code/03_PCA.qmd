...
We summarize these observations by quantifying the average absolute syllable frequency change, which we term the Social Modulation Score (SMS). We observed a significant increase in SMS in males, and a significant decre
...
#saveRDS(SIT_diff, glue('{data_path}/SIT_diff_primary.rds')) # overwrite rds data to in
