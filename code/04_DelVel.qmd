...
em_plot <- ggplot(tests, aes(name, estimate, color = name)) +
    ...
    scale_color_manual(values = c(
        "#030637", "#030637", "#030637",
        "#030637", "#E95793", "gray30"
